        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Left Column - Content */}
            <div className='text-left'>
              ...
              <FadeIn delay={0}>
                <div className='inline-flex items-center gap-2.5 px-[18px] mb-8 py-[11px] bg-linear-to-r from-primary/10 via-primary/15 to-primary/20 border border-primary/20 rounded-full'>
              ...
              <FadeIn delay={200} >
                ...
                <p className='text-lg text-white/70 max-w-[550px] mb-8'>
                  Building modern, scalable and stunning AI-powered SaaS products with Next.Js, React and JavaScript with cutting-edge and modern technologies.
              ...
              <FadeIn delay={300} >
                ...
                >
                  ...
                  <div className='relative z-10 bg-white text-[#212121] rounded-[22px] px-[24px] py-[12px] text-base font-medium border border-e-white hover:bg-white/90 hover:cursor-pointer'>
                    Get In Touch
                  </div>
            ...
            <div className='relative'>
              ...
              <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
                  ...
                  <div className='relative rounded-2xl overflow-hidden m-[1px] h-[calc(100%-2px)]'>
                    ...
                    <img src="/images/photo.png" alt="Priyanshu Paul" className='w-full h-full object-cover' />
